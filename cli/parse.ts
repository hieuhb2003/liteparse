...
program
  ...
  .option("--layout-server-url <url>", "HTTP layout server URL (enables formula + table detection)")
  .option("--no-layout", "Disable layout/formula detection even if URL is set")
