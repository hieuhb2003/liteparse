...
### [paddlex-layout/](./paddlex-layout/)
PaddleX layout detection + formula recognition server.
- Port: **8830**
- Detects formulas (with LaTeX), tables, and other layout elements
- See [LAYOUT_API_SPEC.md](../LAYOUT_API_SPEC.md) for the API spec
